...
int main()
{
	...
	pthread_create(&tid, NULL, zadanie_watku, NULL); //ze skryptu
	...
	pthread_cancel(tid);//ze skrpty
	pthread_join(tid, &wynik);//ze skryptu
	...
	pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED);//s
